...
public class MunicipeService {
    ...
    private final List<Ubication> ubicaciones = new ArrayList<>();

    // Método para cargar datos desde una fuente externa (como un archivo CSV)
    public void cargarDatos(List<Ubication> data) {
    ...
    public Ubication getLocationByCode(String code) {
    ...
    public List<Ubication> getLocationsByName(String name) {
    ...
    public List<Ubication> getLocationsByInitialLetters(String letters) {
        return ubicaciones.stream()
    ...
    public List<Ubication> getLocationsByStateCode(String code) {
        return ubicaciones.stream()
    ...
    public List<Ubication> getLocationsByStartAndEndLetter(String start, String end) {
